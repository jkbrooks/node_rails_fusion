...
var $__proto__support = "(function(o,t){o[\"__proto__\"]={\"a\":t};return o[\"a\"]===t})({},{})";
var $defineProperty = "Object.defineProperty";
var $defineProperties = "Object.defineProperties";
var $create = "Object.create";
var $getOwnPropertyDescriptor = "Object.getOwnPropertyDescriptor";
var objectMixinBody =	"function(t,s){"
	+ "for(var p in s){"
...
var $setPrototypeOf = 'Object.setPrototypeOf||' +
	...
	'}'
;
var $__proto__literal_support = "(function(o){return o[\"a\"]===o[\"__proto__\"][\"a\"]})({\"__proto__\":{\"a\":{}}})";
var $fix__proto__ = 'function(o,f){' +
...
var $SymbolToStringTagBody = "typeof Symbol!=='undefined'&&Symbol&&Symbol[\"toStringTag\"]||'@@toStringTag'";
...
function isTheSameVarDescriptions(d1, d2) {
	return ['persistent', 'template', 'name', 'on', 'deps', 'isFunction', 'self'].every(function(name) {
		var prop1 = d1[name], prop2 = d2[name];
		var isArray1 = Array.isArray(prop1), isArray2 = Array.isArray(prop2);
...
module.exports = {
	createVars: function(node, options) {;var $that$0=this;
		assert(node && node.$scope)

		var core = this;
		var isString = typeof options === 'string';
		var resultName = isString ? options : void 0;
		...
		for ( var name in options ) (function(){if ( options.hasOwnProperty(name) ) {
			var description = standardVars[name];
			...
			if ( description.persistent ) {
				...
				var template = description.template || 'void 0';
				var self = description.self;
